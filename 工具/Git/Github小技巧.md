...
![通过github-readme-stats动态生成GitHub统计信息 ](E:\Pictures\Typora\image-20210616221312426.png)
...
![项目徽章](E:\Pictures\Typora\image-20201107143136559.png)

并且，你不光可以生成静态徽章，shield.io 还可以动态读取你项目的状态并生成对应的徽章。

![自定义项目徽章](E:\Pictures\Typora\image-20201107143502356.png)

生成的描述项目状态的徽章效果如下图所示。

![描述项目状态的徽章](E:\Pictures\Typora\image-20201107143752642.png)

## 自动为项目添加贡献情况图标

通过 repobeats 这个工具可以为 Github 项目添加如下图所示的项目贡献基本情况图表，挺不错的 👍

![img](E:\Pictures\Typora\repobeats.png)

地址：https://repobeats.axiom.co/ 。

## Github 表情

![Github表情](E:\Pictures\Typora\image-20201107162254582.png)
...
![在线Github表情](E:\Pictures\Typora\image-20201107162432941.png)
...
![Chrome插件Octotree](E:\Pictures\Typora\image-20201107144944798.png)
...
![img](E:\Pictures\Typora\image-20201107145749659.png)

使用 SourceGraph 阅读代码的就像下面这样，同样是树形结构展示代码，但是我个人感觉没有 Octotree 的手感舒服。不过，SourceGraph 内置了很多插件，而且还支持类之间的跳转！

![img](E:\Pictures\Typora\image-20201107150307314.png)
...
![img](E:\Pictures\Typora\image-20201107160817672.png)
...
![img](E:\Pictures\Typora\iShot2020-11-07 16.14.14 (1).png)

不过，目前 Github 已经自动为 Markdown 文件生成了目录，只是需要通过点击的方式才能显示出来。

![img](E:\Pictures\Typora\image-20211227093215005.png)
...
![img](E:\Pictures\Typora\github-explore.png)
...
![img](E:\Pictures\Typora\image-20211227100147433.png)

## 源

- https://javaguide.cn/tools/git/github-tips.html