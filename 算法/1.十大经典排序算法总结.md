...
两年前，我曾在[博客园open in new window](https://www.cnblogs.com/guoyaohua/)发布过一篇[《十大经典排序算法最强总结（含 JAVA 代码实现）》open in new window](https://www.cnblogs.com/guoyaohua/p/8600214.html)博文，简要介绍了比较经典的十大排序算法，不过在之前的博文中，仅给出了 Java 版本的代码实现，并且有一些细节上的错误。所以，今天重新写一篇文章，深入了解下十大经典排序算法的原理及实现。
...
- **内部排序** ：数据记录在内存中进行排序。
- **[外部排序open in new window](https://zh.wikipedia.org/wiki/外排序)** ：因排序的数据很大，一次不能容纳全部的排序记录，在排序过程中需要访问外存。

常见的内部排序算法有：**插入排序**、**希尔排序**、**选择排序**、**冒泡排序**、**归并排序**、**快速排序**、**堆排序**、**基数排序**等，本文只讲解内部排序算法。用一张图概括：

![十大排序算法](E:\Pictures\Typora\sort1.png)
...
![排序算法分类](E:\Pictures\Typora\sort2.png)
...
![冒泡排序](E:\Pictures\Typora\bubble_sort.gif)
...
![Selection Sort](E:\Pictures\Typora\selection_sort.gif)
...
![insertion_sort](E:\Pictures\Typora\insertion_sort.gif)
...
![shell_sort](E:\Pictures\Typora\shell_sort.png)
...
![MergeSort](E:\Pictures\Typora\merge_sort.gif)
...
快速排序使用[分治法open in new window](https://zh.wikipedia.org/wiki/分治法)（Divide and conquer）策略来把一个序列分为较小和较大的 2 个子序列，然后递回地排序两个子序列。具体算法描述如下：
...
![RandomQuickSort](E:\Pictures\Typora\random_quick_sort.gif)

### 代码实现

> 来源：[使用 Java 实现快速排序（详解）open in new window](https://segmentfault.com/a/1190000040022056)
...
![HeapSort](E:\Pictures\Typora\heap_sort.gif)
...
![CountingSort](E:\Pictures\Typora\counting_sort.gif)
...
![BucketSort](E:\Pictures\Typora\bucket_sort.gif)
...
![RadixSort](E:\Pictures\Typora\radix_sort.gif)
