...
**参考答案** ：[OSI 和 TCP/IP 网络分层模型详解（基础）](https://javaguide.cn/cs-basics/network/osi&tcp-ip-model.html)。

### 应用层有哪些常见的协议？

[应用层常见协议总结（应用层）](https://javaguide.cn/cs-basics/network/application-layer-protocol.html)
...
![img](E:\Pictures\Typora\url输入到展示出来的过程.jpg)
...
![HTTP 状态码](E:\Pictures\Typora\状态码.png)
...
![HTTP是无状态协议](E:\Pictures\Typora\HTTP是无状态的.png)
...
![路由器的背面就会注明 MAC 位址](E:\Pictures\Typora\2008410143049281.3c367990.png)
