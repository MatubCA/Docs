...
![img](E:\Pictures\Typora\image-20200807161118901.png)
...
![Kernel_Layout](E:\Pictures\Typora\Kernel_Layout-1662546687967-941.png)
...
![windows](E:\Pictures\Typora\windows.f6484c19.png)
...
![unix](E:\Pictures\Typora\unix.0f24ff4b.png)
...
![linux](E:\Pictures\Typora\linux.c4a1a409.png)

#### Mac OS

苹果自家的操作系统，编程体验和 Linux 相当，但是界面、软件生态以及用户体验各方面都要比 Linux 操作系统更好。

![macos](E:\Pictures\Typora\macos.bcc1fe4e.png)
...
![img](E:\Pictures\Typora\L181kk2Eou-compress.jpg)
...
![Linux](E:\Pictures\Typora\Linux之父.bdcddb54.png)
...
![OPINION: Make the switch to a Linux operating system | Opinion ...](E:\Pictures\Typora\Linux-Logo.cfc09e33.png)
...
![文件inode信息](E:\Pictures\Typora\文件inode信息.d9175a2d.png)
...
Linux 文件系统的结构层次鲜明，就像一棵倒立的树，最顶层是其根目录： ![Linux的目录结构](E:\Pictures\Typora\Linux目录树.b82202fa.png)
...
另外，[shell.howopen in new window](https://www.shell.how/) 这个网站可以用来解释常见命令的意思，对你学习 Linux 基本命令以及其他常用命令（如 Git、NPM）。
...
![img](E:\Pictures\Typora\Linux权限解读.7c1098a0.png)
