...
![image-20220912160851009](E:\Pictures\Typora\image-20220912160851009.png)
...
- 用户自定义类型 `@Autowired`
  ...
  2. @Autowired + @Qualifier 基于名字注入
     ...
     ![image-20220911112840275](E:\Pictures\Typora\image-20220911112840275.png)
...
- JDK类型
  ...
  ![image-20220911123217104](E:\Pictures\Typora\image-20220911123217104.png)
...
- 注解和配置文件互通
  ...
  ![image-20220911173501161](E:\Pictures\Typora\image-20220911173501161.png)
...
![image-20220911182141070](E:\Pictures\Typora\image-20220911182141070.png)
...
- 对象的创建
  ...
  ![image-20220911200750984](E:\Pictures\Typora\image-20220911200750984.png)
...
- @Bean注解床架复杂对象的注意事项
  ...
  ![image-20220911203318185](E:\Pictures\Typora\image-20220911203318185.png)
...
- 控制对象的创建次数
  ...
  ![image-20220911204543365](E:\Pictures\Typora\image-20220911204543365.png)
...
- 用户自定义类型
  ...
  ![image-20220911211120620](E:\Pictures\Typora\image-20220911211120620.png)

  简化写法：

  直接调用personDAO方法，以获取PersonDAO对象。

  ![image-20220911211727552](E:\Pictures\Typora\image-20220911211727552.png)
...
- 排除方式
  ...
  ![image-20220911230612158](E:\Pictures\Typora\image-20220911230612158.png)

  同样使用注解也可以使用排除策略的叠加

  ![image-20220911231130159](E:\Pictures\Typora\image-20220911231130159.png)

  需要注意的是type为 aspectj 或者 regex 时使用pattern，其他类型使用value。

- 包含方式

  ![image-20220911231759437](E:\Pictures\Typora\image-20220911231759437.png)
...
![image-20220911232738045](E:\Pictures\Typora\image-20220911232738045.png)
...
- 多配置的信息汇总
  ...
  - 基于base-package进行多个配置bean的整合
    ...
    ![image-20220912090626746](E:\Pictures\Typora\image-20220912090626746.png)

  - 基于@Import注解进行多个配置bean的整合

    @Import作用：创建对象、多配置bean的整合

    ![image-20220912092751267](E:\Pictures\Typora\image-20220912092751267.png)
...
- 跨配置进行注入
  ...
  ![image-20220912103837549](E:\Pictures\Typora\image-20220912103837549.png)
...
![image-20220912115423110](E:\Pictures\Typora\image-20220912115423110.png)
...
1. 基于schema
   ...
   ![](E:\Pictures\Typora\202209121247010.png)

2. 基于特定功能注解

   ![image-20220912125442871](E:\Pictures\Typora\image-20220912125442871.png)

3. 基于原始bean标签

   ![image-20220912130143014](E:\Pictures\Typora\image-20220912130143014.png)

4. 基于@Bean注解

   ![image-20220912131116645](E:\Pictures\Typora\image-20220912131116645.png)
...
![image-20220912211514035](E:\Pictures\Typora\image-20220912211514035.png)
...
![image-20220912212814686](E:\Pictures\Typora\image-20220912212814686.png)
