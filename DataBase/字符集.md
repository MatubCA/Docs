...
![ASCII字符编码](E:\Pictures\Typora\c1c6375d08ca268690cef2b13591a5b4.png)
...
![img](E:\Pictures\Typora\836c49b117ee4408871b0020b74c991d.png)

这样我们就搞懂了乱码的本质： **编码和解码时用了不同或者不兼容的字符集** 。

![img](E:\Pictures\Typora\a8808cbabeea49caa3af27d314fa3c02-1.jpg)
...
![img](E:\Pictures\Typora\1280px-Utf8webgrowth.svg.png)

## [#](https://javaguide.cn/database/character-set.html#mysql-字符集)MySQL 字符集

MySQL 支持很多种字符编码的方式，比如 UTF-8、GB2312、GBK、BIG5。

你可以通过 `SHOW CHARSET` 命令来查看。

![img](E:\Pictures\Typora\image-20211008164229671.png)
...
![img](E:\Pictures\Typora\image-20211008164542347.png)
