...
![img](E:\Pictures\Typora\5e3c1a71724a38245aa43b02_99bf70d46cc247be878de9d3a88f0c44.png)
...
![img](E:\Pictures\Typora\20210327143351823.png)
...
![img](E:\Pictures\Typora\13526879-3037b144ed09eb88.png)
...
![查看 MySQL 提供的所有存储引擎](E:\Pictures\Typora\image-20220510105408703.png)
...
![查看 MySQL 当前默认的存储引擎](E:\Pictures\Typora\image-20220510105837786.png)

如果你只想查看数据库中某个表使用的存储引擎的话，可以使用 `show table status from db_name where name='table_name'`命令。

![查看表的存储引擎](E:\Pictures\Typora\image-20220510110549140.png)
...
![img](E:\Pictures\Typora\image-20220510155143458.png)
...
![img](E:\Pictures\Typora\20210327145248960.png)
...
![img](E:\Pictures\Typora\image-20220510090309427.png)
...
![事务示意图](E:\Pictures\Typora\事务示意图.png)
...
![数据库事务示意图](E:\Pictures\Typora\数据库事务示意图.png)

另外，关系型数据库（例如：`MySQL`、`SQL Server`、`Oracle` 等）事务都有 **ACID** 特性：

![ACID](E:\Pictures\Typora\ACID.png)
...
![AID->C](E:\Pictures\Typora\AID-C.png)
...
![img](E:\Pictures\Typora\20210526162552353.png)
...
![img](E:\Pictures\Typora\image-20220511171419081.png)
...
![img](E:\Pictures\Typora\oss-search.png)

也可以选择自建文件存储服务，实现起来也不难，基于FastDFS、MinIO（推荐） 等开源项目就可以实现分布式文件服务。

**数据库只存储文件地址信息，文件由文件存储服务负责存储。**

相关阅读：[Spring Boot 整合 MinIO 实现分布式文件服务，真香！open in new window](https://mp.weixin.qq.com/s/xfYCESLOuq3_0e3SFj6ZMQ) 。
