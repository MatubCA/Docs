...
![HTTP1.0cache1](E:\Pictures\Typora\HTTP1.0cache1.2f2b7eac.png)

![HTTP1.0cache2](E:\Pictures\Typora\HTTP1.0cache2.7430070e.png)

### HTTP/1.1

HTTP/1.1的缓存机制在HTTP/1.0的基础上，大大增加了灵活性和扩展性。基本工作原理和HTTP/1.0保持不变，而是增加了更多细致的特性。其中，请求头中最常见的特性就是`Cache-Control`，详见MDN Web文档 [Cache-Controlopen in new window](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Headers/Cache-Control).
...
![HTTP1.1continue2](E:\Pictures\Typora\HTTP1.1continue2.7d63532b.png)
...
- https://javaguide.cn/cs-basics/network/http1.0&http1.1.html