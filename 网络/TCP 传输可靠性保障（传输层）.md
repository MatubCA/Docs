...
![TCP发送窗口结构](E:\Pictures\Typora\tcp-send-window.png)
...
![TCP接收窗口结构](E:\Pictures\Typora\tcp-receive-window.png)
...
![TCP的拥塞控制](E:\Pictures\Typora\tcp-congestion-control.png)
...
1. 《计算机网络（第 7 版）》
2. 《图解 HTTP》
3. [https://www.9tut.com/tcp-and-udp-tutorialopen in new window](https://www.9tut.com/tcp-and-udp-tutorial)
4. [https://github.com/wolverinn/Waking-Up/blob/master/Computer%20Network.mdopen in new window](https://github.com/wolverinn/Waking-Up/blob/master/Computer Network.md)
5. TCP Flow Control—[https://www.brianstorti.com/tcp-flow-control/open in new window](https://www.brianstorti.com/tcp-flow-control/)
